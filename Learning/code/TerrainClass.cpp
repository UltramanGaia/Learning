...
//--------------------------------------------------------------------------------------
BOOL TerrainClass::InitTerrain(INT nRows, INT nCols, float fSpace, float fScale,float fUTextureNumbers, float fVTextureNumbers)//fUTextureNumbers,fVTextureNumbers横竖纹理图铺满所用的张数 
{
...
float TerrainClass::getPositionHeight(D3DXVECTOR3 pos)
{
